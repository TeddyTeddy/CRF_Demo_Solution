...
if __name__ == '__main__':
    ...
    register_form_data_generator = register_form_data_generator_factory(usernames, passwords,
                                   first_names, last_names, phone_numbers, use_existing_form_data_set=True)
    for register_form_data in register_form_data_generator:
        # register_form_data is of type dict
